    ...
    <div className="min-h-screen bg-[#ece8e2] md:p-6 lg:p-10 flex items-center justify-center font-sans">
      ...
      <div className="w-full max-w-[1200px] mx-auto flex flex-col md:flex-row h-[100vh] md:h-[800px] md:rounded-[40px] overflow-hidden bg-[#e6ded4] md:bg-transparent shadow-2xl md:shadow-none">
        ...
        <div className="md:hidden w-full h-[40vh] relative">
          ...
          />
          {/* Top dark gradient for status bar visibility */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent h-24"></div>
        </div>

        {/* ── LEFT COLUMN: Login Card (Mobile: overlaps from bottom) ── */}
        <div className="flex-1 flex flex-col relative z-10 -mt-10 md:mt-0 rounded-t-[40px] md:rounded-[40px] bg-gradient-to-br from-[#eadbcc] to-[#dfdec0] p-8 md:p-12 lg:p-16 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] md:shadow-xl border border-white/20">
          ...
          <div className="flex justify-between items-center mb-16">
            ...
            <Link to="/signup" className="text-[#1b2028] font-semibold hover:opacity-70 transition-opacity">
              Sign up
            </Link>
          </div>
          ...
          <div className="flex items-center justify-between mb-10">
             ...
             <button className="hidden sm:flex items-center gap-2 border border-[#1b2028]/20 rounded-full px-4 py-1.5 text-xs font-semibold hover:bg-white/30 transition-colors">
               <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.04c-5.5 0-10 4.49-10 10.02 0 5 3.66 9.15 8.44 9.9v-7H7.9v-2.9h2.54V9.85c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.23.19 2.23.19v2.47h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.45 2.9h-2.33v7a10 10 0 0 0 8.44-9.9c0-5.53-4.5-10.02-10-10.02z"/></svg>
               Facebook
             </button>
          </div>
          ...
          {/* Decorative Footer Abstract Shapes */}
          <div className="mt-auto pt-10 flex items-center justify-center gap-4 opacity-60">
             ...
             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1b2028" strokeWidth="2"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-1 bg-[#faf9f7] rounded-[40px] ml-6 relative overflow-hidden p-12 flex-col justify-between shadow-xl">
           ...
           {/* The Soft Pink Circle Background Element */}
           ...
           <div className="z-10 relative flex justify-between items-end">
             ...
             <div className="flex items-center bg-[#1b2028] text-white rounded-full p-1 pl-4 gap-3 cursor-pointer hover:bg-black transition-colors">
               <span className="text-xs font-bold">Click Here</span>
